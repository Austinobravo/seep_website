...
const DesktopNav = () => {
  ...
  return (
    <section className='flex justify-center items-center'>
        <div className={`bg-white p-2 w-full mx-auto  ${isNavScrolling ? "fixed top-0 px-15 py-5" : "absolute rounded-full max-w-249 top-4"} z-55 transition-all duration-700 ease-in-out  `}>
            <div className='max-w-360 flex justify-between items-center mx-auto'>
                <Link href="/">
