...
const BlogDetailContent = ({ sections, blog }: BlogDetailContentProps) => {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-12 pb-6">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-slate-500 font-medium mb-10">Last updated: {blog.updatedAt}</p>
            ...
            {/* <article className="lg:w-3/4 space-y-16">
              ...
              <div id="institutions" className="space-y-6">
                ...
                <div className="relative w-full h-[400px] rounded-[2rem] overflow-hidden shadow-md mt-6">
                  <Image src={blog.heroImage} alt={blog.title} fill className="object-cover" />
                </div>
              </div>
                ...
                {blog.sections.map((section) => (
                    ...
                    {section.content.map((block, index) => {
                        ...
                        case "image":
                            ...
                            <div
                                key={index}
                                className="relative h-[450px] rounded-[2rem] overflow-hidden"
                            >
                                <Image
                                src={block.src}
                                alt={block.alt}
